using companyApplication.Server;
...
namespace companyApp.Server.Controllers
{
    ...
    public class CompanyController : ControllerBase
    {
        ...
        public CompanyController(ApplicationContext context, ILogger<CompanyController> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<CompanyEntity>>> GetCompanies()  // task - для асинхронности  
